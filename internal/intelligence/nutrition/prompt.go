...
5. Determine nutrition facts per 100g for EACH item (calories, protein, fat, carbs)
...
- Use realistic nutrition values consistent with standard nutrition databases (e.g., USDA FoodData Central).
SECURITY RULES:
